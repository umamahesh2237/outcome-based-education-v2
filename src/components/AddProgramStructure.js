  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className="regulation-form">
        <h3>Click button to download program structure template:</h3>
        <hr />
        <button type="button" onClick={handleDownloadTemplate} className="download-button">
          Download Excel Template
        </button>
        <br></br><br></br>
        <h3>Upload program structure file:</h3><hr/>
        <input type="file" onChange={handleFileUpload} accept=".xlsx,.xls" className="file-upload" />
        <br></br><br></br>
        <h3>Fetch the program structure (Regulation and Semester-Wise):</h3>
        <hr />
        ...
        <button type="submit" className="submit-button"><b>Fetch Program Structure</b></button>
        ...
        {programStructures.length > 0 && (
          <div className="table-responsive mt-4">
            <div className="d-flex justify-content-between mb-3">
              ...
              <h4>Regulation: {selectedRegulation}</h4>
            </div>
